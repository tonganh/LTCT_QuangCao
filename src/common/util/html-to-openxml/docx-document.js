...
class DocxDocument {
  ...
  generateDocumentXML() {
    ...
    // .att('a', namespaces.a)
    // .att('cdr', namespaces.cdr)
    // .att('o', namespaces.o)
    // .att('pic', namespaces.pic)
    // .att('r', namespaces.r)
    // .att('v', namespaces.v)
    // .att('ve', namespaces.ve)
    // .att('vt', namespaces.vt)
    // .att('w', namespaces.w)
    // .att('w10', namespaces.w10)
    // .att('wp', namespaces.wp)
    // .att('vne', namespaces.vne)
    documentXML.root().import(this.documentXML);
